  ...
  return (
    ...
    relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20'>
      ...
      <div className='flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6'>
        ...
        xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded'>
          <h2 className='regular-24 md:regular-32 2xl:regular-64 capitalize text-white'>
            <strong>Feeling Lost</strong> And Not Knowing The Way?
          </h2>
          <p className='regular-14 xl:regular-16 mt-5 text-white'>
            Starting from the anxiety of the climber when visiting a new climbing location, the
            possibility of getting lost is very larg. That's why we are here for those of you 
